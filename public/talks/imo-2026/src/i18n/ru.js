	...
	beats: {
		...
		'slide-roster': {
			...
			notes: 'Список сквозь сорок лет: между 1984 и 2016 — многоточие, это отдельный разговор. '
				+ 'Два клика: сначала 2016-й (приглушённо — не прошли), потом остальные три строки.',
		},
		'sovenok': {
			title: 'Совёнок',
	...
	slides: {
		...
		'roster': `
			...
			<ul>
				...
				<li data-at="1" class="dim"><span class="y">2016</span><span>чуть не хватило
					Андрею Сергунину и Илье Думанскому — кандидаты в сборную</span></li>
				<li data-at="2"><span class="y">2017</span><span>Никита Добронравов (брат-близнец Егор — кандидат)</span></li>
				<li data-at="2"><span class="y">2019, 2020</span><span>Алексей Львов</span></li>
				<li data-at="2"><span class="y">2023, 2024</span><span>Ратибор Коптилин</span></li>
			</ul>`,
		...
		// Заголовок и QR-код здесь не текст и не картинка, а точки на холсте
		// (см. slides/balls.js): пустые .head и .qr держат под них место в потоке.
		'howto': `
